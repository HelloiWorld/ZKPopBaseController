...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    //自定义动画
    [toViewController.view.subviews objectAtIndex:0].layer.frame = CGRectMake(width.floatValue, [toViewController.view.subviews objectAtIndex:0].frame.origin.y, 0, height.floatValue-32*kScreenScale);
    
    [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
        
        [fromViewController.view.subviews objectAtIndex:0].layer.frame = CGRectMake(-width.floatValue, [toViewController.view.subviews objectAtIndex:0].frame.origin.y, width.floatValue, height.floatValue-32*kScreenScale);
